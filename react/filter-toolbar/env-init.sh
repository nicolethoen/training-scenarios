...
curl -L https://raw.githubusercontent.com/patternfly/training-scenarios/master/react/filter-toolbar/assets/input.js > ~/tutorial/src/components/input.js
curl -L https://raw.githubusercontent.com/patternfly/training-scenarios/master/react/filter-toolbar/assets/kebab.js > ~/tutorial/src/components/kebab.js
curl -L https://raw.githubusercontent.com/patternfly/training-scenarios/master/react/filter-toolbar/assets/table.js > ~/tutorial/src/components/table.js
